...
class Eu_Cookie_Notice_Admin {
    ...
    public function eu_cookie_notice_about() {
        ...
        if (!get_option('eucnotice_plugin_notice_shown')) {
            ?>
            <div id="eucnotice_dialog">
                <p><?php _e('Be the first to get latest updates and exclusive content straight to your email inbox.'); ?></p>
                <p><input type="text" id="txt_user_sub_eucnotice" class="regular-text" name="txt_user_sub_eucnotice" value="<?php echo $current_user->user_email; ?>"></p>
            </div>
        <?php } ?>
                                    ...
                                    <tbody>
                                                ...
                                                <div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    ...
                                                    if ($getcwoptionarray != '') {
                                                        if (isset($getcwoptionarray['cw_cookie_bar_enabled']) && $getcwoptionarray['cw_cookie_bar_enabled'] != '' && !empty($getcwoptionarray['cw_cookie_bar_enabled'])) {
                                                            ?>
                                                            <label><input <?php
                                                                if (isset($getcwoptionarray['cw_cookie_bar_enabled']) && $getcwoptionarray['cw_cookie_bar_enabled'] == 'yes') {
                                                                    echo 'checked';
                                                                }
                                                                ?> type="radio" checked name="cw_cookie_bar_enabled" value="yes"><?php echo __('On', EUCN_PLUGIN_SLUG); ?></label>
                                                            <label><input <?php
                                                                if (isset($getcwoptionarray['cw_cookie_bar_enabled']) && $getcwoptionarray['cw_cookie_bar_enabled'] == 'no') {
                                                                    echo 'checked';
                                                                }
                                                                ?> type="radio" name="cw_cookie_bar_enabled" value="no"><?php echo __('Off', EUCN_PLUGIN_SLUG); ?></label><?php } else {
                                                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    ...
                                                    if (isset($getcwoptionarray['cw_refuse_on_scroll']) && $getcwoptionarray['cw_refuse_on_scroll'] == '1') {
                                                        echo"checked";
                                                    }
                                                    ?> value="<?php echo isset($getcwoptionarray['cw_refuse_on_scroll']) ? $getcwoptionarray['cw_refuse_on_scroll'] : '0'; ?>" name="cw_refuse_on_scroll_btn" id="cw_refuse_on_scroll_btn" ><?php echo EUCN_PLUGIN_ON_SCROLL_OPTION_TEXT; ?>
                                                </div>
                                                <div <?php
                                                if (isset($getcwoptionarray['cw_refuse_on_scroll']) && $getcwoptionarray['cw_refuse_on_scroll'] == '1') {
                                                ...
                                                ?> class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>onscroll_contain">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="cw_cookie_expiry_time">
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == '1day') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="1day">1 day</option>
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == '1week') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="1week">1 week</option>
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == '1month') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="1month">1 month</option> 
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == '3months') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="3months">3 months</option>
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == '6months') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="6months">6 months</option>
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == '1year') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="1year">1 year</option>
                                                    <option <?php
                                                    if (isset($getcwoptionarray['cw_cookie_expiry_time']) && $getcwoptionarray['cw_cookie_expiry_time'] == 'infinity') {
                                                        echo 'selected';
                                                    }
                                                    ?> value="infinity">infinity</option>
                                                </select>
                                            ...
                                            <td>
                                                ...
                                                if ($getcwoptionarray != '') {
                                                    if (isset($getcwoptionarray['cw_cookie_script_placement']) && $getcwoptionarray['cw_cookie_script_placement'] != '' && !empty($getcwoptionarray['cw_cookie_script_placement'])) {
                                                        ?>
                                                        <label><input <?php
                                                            if (isset($getcwoptionarray['cw_cookie_script_placement']) && $getcwoptionarray['cw_cookie_script_placement'] == 'header') {
                                                                echo 'checked';
                                                            }
                                                            ?> type="radio" checked name="cw_script_placement" value="header"><?php echo __('Header', EUCN_PLUGIN_SLUG); ?></label>
                                                        <label><input <?php
                                                            if (isset($getcwoptionarray['cw_cookie_script_placement']) && $getcwoptionarray['cw_cookie_script_placement'] == 'footer') {
                                                                echo 'checked';
                                                            }
                                                            ?> type="radio" name="cw_script_placement" value="footer"><?php echo __('Footer', EUCN_PLUGIN_SLUG); ?></label><?php } else {
                                                            ?>
                                        ...
                                        <tr style="display:none;">
                                            ...
                                            <td><input type="checkbox" <?php
                                                if (isset($getcwoptionarray['cw_deactivation_option']) && $getcwoptionarray['cw_deactivation_option'] == '1') {
                                                    echo'checked';
                                                }
                                                ?> value="<?php echo isset($getcwoptionarray['cw_deactivation_option']) ? $getcwoptionarray['cw_deactivation_option'] : '0'; ?>" name="cw_deactivation_option" id="cw_deactivation_option"></td>
                                        </tr>
                                        <tr>
                                                ...
                                                if ($getcwoptionarray != '') {
                                                    if (isset($getcwoptionarray['cw_message_position']) && $getcwoptionarray['cw_message_position'] != '' && !empty($getcwoptionarray['cw_message_position'])) {
                                                        ...
                                                        <label><input type="radio" <?php
                                                            if (isset($getcwoptionarray['cw_message_position']) && $getcwoptionarray['cw_message_position'] == 'top') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_msg_position" class="cw_msg_position" value="top"><?php echo __('Sticky Top', EUCN_PLUGIN_SLUG); ?> <img class="msg_position" alt="sticky top" src="<?php echo plugin_dir_url(__FILE__) . 'images/top__image.jpg' ?>" /></label>
                                                        <label><input type="radio" <?php
                                                            if (isset($getcwoptionarray['cw_message_position']) && $getcwoptionarray['cw_message_position'] == 'bottom') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_msg_position" class="cw_msg_position" value="bottom"><?php echo __('Sticky Bottom', EUCN_PLUGIN_SLUG); ?>  <img class="msg_position" alt="sticky bottom" src="<?php echo plugin_dir_url(__FILE__) . 'images/bottom__image.jpg' ?>" /></label>
                                                        <label><input type="radio" <?php
                                                            if (isset($getcwoptionarray['cw_message_position']) && $getcwoptionarray['cw_message_position'] == 'fancybox') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_msg_position" class="cw_msg_position" value="fancybox"><?php echo __('Popup', EUCN_PLUGIN_SLUG); ?> <img class="msg_position" alt="popup" src="<?php echo plugin_dir_url(__FILE__) . 'images/popup__image.jpg' ?>" /></label><?php } else {
                                                            ?>
                                            ...
                                            <td >
                                                ...
                                                if ($getcwoptionarray != '') {
                                                    if (isset($getcwoptionarray['cw_message_animation']) && $getcwoptionarray['cw_message_animation'] != '' && !empty($getcwoptionarray['cw_message_animation'])) {
                                                        ?>
                                                        <label><input type="radio"  <?php
                                                            if (isset($getcwoptionarray['cw_message_animation']) && $getcwoptionarray['cw_message_animation'] == 'none') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_msg_animation" class="cw_msg_animation" value="none"><?php echo __('None', EUCN_PLUGIN_SLUG); ?></label>
                                                        <label><input type="radio"  <?php
                                                            if (isset($getcwoptionarray['cw_message_animation']) && $getcwoptionarray['cw_message_animation'] == 'fade') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_msg_animation" class="cw_msg_animation" value="fade"><?php echo __('Fade', EUCN_PLUGIN_SLUG); ?></label>
                                                        <label><input type="radio"  <?php
                                                            if (isset($getcwoptionarray['cw_message_animation']) && $getcwoptionarray['cw_message_animation'] == 'slide') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_msg_animation" class="cw_msg_animation" value="slide"><?php echo __('Slide', EUCN_PLUGIN_SLUG); ?></label>
                                                                  <?php } else { ?>
                                                ...
                                                <div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    ...
                                                    if ($getcwoptionarray != '') {
                                                        if (isset($getcwoptionarray['cw_cookie_auto_hide']) && $getcwoptionarray['cw_cookie_auto_hide'] != '' && !empty($getcwoptionarray['cw_cookie_auto_hide'])) {
                                                            ?>
                                                            <label><input <?php
                                                                if (isset($getcwoptionarray['cw_cookie_auto_hide']) && $getcwoptionarray['cw_cookie_auto_hide'] == 'yes') {
                                                                    echo 'checked';
                                                                }
                                                                ?> type="radio" checked name="cw_cookie_auto_hide" value="yes"><?php echo __('On', EUCN_PLUGIN_SLUG); ?></label>
                                                            <label><input <?php
                                                                if (isset($getcwoptionarray['cw_cookie_auto_hide']) && $getcwoptionarray['cw_cookie_auto_hide'] == 'no') {
                                                                    echo 'checked';
                                                                }
                                                                ?> type="radio" name="cw_cookie_auto_hide" value="no"><?php echo __('Off', EUCN_PLUGIN_SLUG); ?></label><?php } else {
                                                                ?>
                                                ...
                                                <div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    ...
                                                    if ($getcwoptionarray != '') {
                                                        if (isset($getcwoptionarray['cw_cookie_auto_hide_seconds']) && $getcwoptionarray['cw_cookie_auto_hide_seconds'] != '' && !empty($getcwoptionarray['cw_cookie_auto_hide_seconds'])) {
                                                            ?>
                                                            <input type="text" value="<?php echo!empty($getcwoptionarray['cw_cookie_auto_hide_seconds']) ? $getcwoptionarray['cw_cookie_auto_hide_seconds'] : '5000'; ?>" name="cw_cookie_auto_hide_seconds"><?php } else {
                                                            ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    <input type="checkbox" <?php
                                                    if (isset($getcwoptionarray['cw_more_info_link']) && $getcwoptionarray['cw_more_info_link'] != '' && $getcwoptionarray['cw_more_info_link'] == '1') {
                                                        echo "checked";
                                                    }
                                                    ?> value="<?php echo isset($getcwoptionarray['cw_more_info_link']) ? $getcwoptionarray['cw_more_info_link'] : "0"; ?>" name="cw_more_info_links" id="cw_more_info_links" ><?php echo EUCN_PLUGIN_MORE_LINK_OPTION; ?>
                                                </div>
                                                <div  <?php
                                                if (isset($getcwoptionarray['cw_more_info_link']) && $getcwoptionarray['cw_more_info_link'] != '' && $getcwoptionarray['cw_more_info_link'] == '1') {
                                                    echo 'style="display:block"';
                                                ...
                                                ?> class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>more_info">
                                                    ...
                                                    <?php if (!empty($getcwoptionarray['cw_more_info_link']) && $getcwoptionarray['cw_more_info_link'] != '' && $getcwoptionarray['cw_more_info_link'] == '1') { ?> 
                                                        <label><input type="radio" <?php
                                                            if (isset($getcwoptionarray['cw_page_attribte']) && $getcwoptionarray['cw_page_attribte'] == 'custom') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_page_link_attribute" value="custom" class="cw_page_custom_link" >Custom Link</label>
                                                        <label><input type="radio" <?php
                                                            if (isset($getcwoptionarray['cw_page_attribte']) && $getcwoptionarray['cw_page_attribte'] == 'pages') {
                                                                echo 'checked';
                                                            }
                                                            ?> name="cw_page_link_attribute" value="pages" class="cw_page_custom_link">Page Link</label>
                                                                  <?php } else { ?>
                                                    ...
                                                    ?> class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>custom_link_option">
                                                    ...
                                                    ?> class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>page_link_option">
                                                            ...
                                                            if (isset($posts_array) && !empty($posts_array) && $posts_array != '') {
                                                                foreach ($posts_array as $key => $value) {
                                                                    ...
                                                                    <?php if (isset($getcwoptionarray['cw_page_select_links']) && $getcwoptionarray['cw_page_select_links'] != '' && !empty($getcwoptionarray['cw_page_select_links'])) { ?>
                                                                        <option <?php
                                                                        if (isset($getcwoptionarray['cw_page_select_links']) && $getcwoptionarray['cw_page_select_links'] == $value->ID) {
                                                                            echo "selected";
                                                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    <select name="cw_target_attribute">
                                                        <option <?php
                                                        if (isset($getcwoptionarray['cw_page_link_target']) && $getcwoptionarray['cw_page_link_target'] != '' && $getcwoptionarray['cw_page_link_target'] == '_blank') {
                                                            echo 'selected';
                                                        }
                                                        ?> value="_blank">_blank</option>
                                                        <option <?php
                                                        if (isset($getcwoptionarray['cw_page_link_target']) && $getcwoptionarray['cw_page_link_target'] != '' && $getcwoptionarray['cw_page_link_target'] == '_self') {
                                                            echo 'selected';
                                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>row">
                                                    <input type="checkbox" <?php
                                                    if (isset($getcwoptionarray['cw_refuse_btn_chk']) && $getcwoptionarray['cw_refuse_btn_chk'] == '1') {
                                                        echo"checked";
                                                    }
                                                    ?> value="<?php echo isset($getcwoptionarray['cw_refuse_btn_chk']) ? $getcwoptionarray['cw_refuse_btn_chk'] : '0'; ?>" name="cw_refuse_chk_btn" id="cw_refuse_chk_btn" ><?php echo EUCN_PLUGIN_REFUSE_OPTION_TEXT; ?> (Give to the user the possibility to refuse third party non functional cookies.)
                                                </div>
                                                <div <?php
                                                if (isset($getcwoptionarray['cw_refuse_btn_chk']) && $getcwoptionarray['cw_refuse_btn_chk'] == '1') {
                                                    echo 'style="display:block"';
                                                ...
                                                ?> class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>refuse_contain">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($getcwoptionarray['cw_button_style']) && $getcwoptionarray['cw_button_style'] != '') { ?> 
                                                    <label><input type="radio" <?php
                                                        if ($getcwoptionarray['cw_button_style'] == 'none') {
                                                            echo 'checked';
                                                        }
                                                        ?>  name="cw_msg_btn_styles" class="cw_msg_btn_style" value="none">None</label>
                                                    <label><input type="radio" <?php
                                                        if ($getcwoptionarray['cw_button_style'] == 'wordpress') {
                                                            echo 'checked';
                                                        }
                                                        ?> name="cw_msg_btn_styles" class="cw_msg_btn_style" value="wordpress">WordPress </label>
                                                    <label><input type="radio" <?php
                                                        if ($getcwoptionarray['cw_button_style'] == 'bootstrap') {
                                                            echo 'checked';
                                                        }
                                                        ?> name="cw_msg_btn_styles" class="cw_msg_btn_style" value="bootstrap">Bootstrap</label>
                                                              <?php } else { ?> 
                                                ...
                                                if ($getcwoptionarray != '') {
                                                    if ($getcwoptionarray['cw_button_style'] != '' && !empty($getcwoptionarray['cw_button_style'])) {
                                                        ...
                                                        ?> class="<?php echo EUCN_HTML_CLASS_PREFIX; ?>custom_button_style">
    ...
    public function wp_add_plugin_eucnotice_userfn() {
        ...
        if (!empty($email_id)) {
            $request_response = wp_remote_post($request_url, array('method' => 'POST',
                ...
                'blocking' => true,
                'headers' => array(),
                'body' => array('user' => array('plugin_id' => '34', 'user_email' => $email_id, 'plugin_site' => $log_url, 'status' => 1, 'activation_date' => $cur_date)),
                'cookies' => array()));
